...
def derp_it(derping=False):
    ...
    first_name_label = label.Label(name_font, text="Milos", color=color, scale=2)
    last_name_label = label.Label(name_font, text="Marinkovic", color=color, scale=2)
    contact_label = label.Label(contact_font, text="milosmns@gmail.com", color=color, scale=1)
