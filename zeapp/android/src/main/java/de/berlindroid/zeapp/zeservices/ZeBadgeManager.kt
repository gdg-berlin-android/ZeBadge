...
class ZeBadgeManager
    ...
    constructor(
        ...
        suspend fun updateConfiguration(configuration: Map<String, Any?>): Result<Any> {
            ...
            val payload =
                BadgePayload.ConfigUpdatePayload(
                    config = config,
                )
...
private fun kotlinToPython(value: Any?): String =
    when (value) {
        null -> "None"
